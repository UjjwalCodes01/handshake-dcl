...
**Handshake** — a mobile-first social multiplayer Decentraland **SDK7** scene, deployed to the World `maincharacter.dcl.eth`, for the Friendzone Mobile Buildathon (deadline **Sep 4, 2026**).
